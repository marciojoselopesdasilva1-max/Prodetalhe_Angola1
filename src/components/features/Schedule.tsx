...
export function Schedule() {
  return (
    <section className="py-16 md:py-24 bg-[#121214]">
      <div className="container mx-auto px-4 md:px-6 max-w-3xl">
        
        {/* Map Section */}
        <div className="w-full h-64 md:h-80 rounded-2xl overflow-hidden mb-8 border border-white/10 shadow-lg">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3942.664875389658!2d13.230755914785233!3d-8.822851993663675!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1a51f15cdc8d2c7d%3A0x850c1c5c5ecc5a9!2sLuanda%2C%20Angola!5e0!3m2!1sen!2spt!4v1700000000000!5m2!1sen!2spt" 
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
        ...
        {/* Form Container */}
        <div id="agendamento" className="bg-[#18181b] border border-white/10 rounded-2xl p-6 md:p-10 shadow-2xl scroll-mt-24">
